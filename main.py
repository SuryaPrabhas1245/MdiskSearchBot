...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/165941ae764a56d6d9c89.jpg",
                                ...
                                reply_markup=InlineKeyboardMarkup([
                                    [InlineKeyboardButton("Updates 🤖", url="https://t.me/+FF0sDKMQkFsyYmQ1"),
                                     InlineKeyboardButton("Owner ⚡", url="https://t.me/SuryaPrabhas")],
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Updates 🤖", url="https://t.me/+FF0sDKMQkFsyYmQ1"),
						InlineKeyboardButton("Support 😵‍💫", url="https://t.me/DickHolder")
					],
					[
						InlineKeyboardButton("Owner ⚡", url="https://t.me/SuryaPrabhas"),
